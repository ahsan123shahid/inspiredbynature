...
const AdminSubCategories = () => {
  ...
  const resetForm = () => {
    setForm({ subcat_title: "", subcat_img: "", cat_id: "", handle: "", SEOtitle: "", SEOdescription: "" });
    setImgError(false);
    setEditing(null);
    setShowForm(false);
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!form.subcat_title.trim() || !form.cat_id) { toast.error("Title and category are required"); return; }
    setSaving(true);
    try {
      if (editing) {
    ...
    <div className="p-4 lg:p-6">
      <div className="flex items-center justify-between mb-5">
        ...
        <button onClick={() => { resetForm(); setShowForm(true); }}
          ...
          <HiPlus className="text-lg" /> Add Subcategory
        </button>
      </div>
        ...
        <div className="fixed inset-0 z-50">
          ...
          <div className="absolute right-0 top-0 bottom-0 w-full max-w-lg bg-white shadow-xl overflow-y-auto">
            <div className="flex items-center justify-between px-6 py-4 border-b border-[#e0e0e0]">
              <h2 className="text-base font-semibold text-[#202223]">{editing ? "Edit" : "Add"} Subcategory</h2>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-1">
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        setSelectedMediaName(form.subcat_img || null);
                  ...
                  {form.subcat_img && !imgError ? (
                    ...
                    <div className="w-20 h-20 bg-gray-50 border border-gray-200 rounded-md flex items-center justify-center text-[#6d7175] text-xs flex-shrink-0">
                      {form.subcat_img ? "Invalid" : "No image"}
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="flex gap-3 pt-2">
                ...
                >{saving ? "Saving..." : editing ? "Update" : "Add Subcategory"}</button>
                    ...
                    .map((item) => {
                      ...
                      return (
                        <div
                          ...
                          onDoubleClick={() => {
                            setForm({ ...form, subcat_img: item.name });
                            setImgError(false);
              ...
              <button
                ...
                onClick={() => {
                  if (selectedMediaName) {
                    setForm({ ...form, subcat_img: selectedMediaName });
                    setImgError(false);
                    setShowMediaModal(false);
                  }
                }}
