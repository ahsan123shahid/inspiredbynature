...
class StoreSeeder extends Seeder
{
    public function run(): void
    {
        if (Store::count() > 0) {
            $store = Store::first();
            $settings = [
                "announcement" => ["text" => "WELCOME TO GEMINI NANO PERFUMES — Free Shipping Nationwide", "bg_color" => "#000000", "text_color" => "#ffffff", "enabled" => true],
                ...
                "slides" => [
                    ...
                    ["id" => "2", "title" => "GEMINI NANO PERFUMES", "subtitle" => "EXPERIENCE CTRINE, KAWKAB AND SCENTIQUE WHITE", "image" => "banner.jpg", "btn_text" => "SHOP COLLECTION", "btn_link" => "/shop/perfumes"],
                ],
